...
policyFile = "/home/mininet/pox/pox/misc/firewallpolicies.csv"
if now < today8am :
        policyFile = "/home/mininet/pox/pox/misc/firewallpolicies1.csv"
log.info("Firewall has been enabled")
log.info("Host to Host connections are being monitored")
